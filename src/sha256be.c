...
void SHA256Finalize(SHA256Context *context, uint8_t Pad_Byte);
void SHA256PadMessage(SHA256Context *context, uint8_t Pad_Byte);
int SHA256ResultN(SHA256Context *context,uint8_t Message_Digest[ ], int HashSize);
...
int SHA256Result(SHA256Context *context, uint8_t Message_Digest[SHA256HashSize]) {
  return SHA256ResultN(context, Message_Digest, SHA256HashSize);
}
